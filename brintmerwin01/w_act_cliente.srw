HA$PBExportHeader$w_act_cliente.srw
forward
...
string title = "Tipo de Actualizaci$$HEX1$$f300$$ENDHEX$$n"
...
if isnull(ll_tipoact) then
	messagebox('Aviso','Debe seleccionarse un tipo de actualizaci$$HEX1$$f300$$ENDHEX$$n primero')
	return
end if
