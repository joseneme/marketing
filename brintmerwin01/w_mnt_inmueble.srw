HA$PBExportHeader$w_mnt_inmueble.srw
...
if f_dw_modify(dw_maestro) then
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "nombre")) then
		messageBox ("Error al grabar los datos","campo 'Nombre Inmueble' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
   end if
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "tipviap")) then
		messageBox ("Error al grabar los datos","campo 'Tipo V$$HEX1$$ed00$$ENDHEX$$a' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
   end if
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "nomvia")) or &
		dw_maestro.getitemstring(ll_row_maestro, "nomvia") = '' then
		messageBox ("Error al grabar los datos","campo 'Nombre V$$HEX1$$ed00$$ENDHEX$$a' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
   end if
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "numvia")) or &
		dw_maestro.getitemstring(ll_row_maestro, "numvia") = '' then
		messageBox ("Error al grabar los datos","campo 'N$$HEX1$$fa00$$ENDHEX$$mero' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
   end if
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "codpos")) or &
		dw_maestro.getitemstring(ll_row_maestro, "codpos") = '' then
		messageBox ("Error al grabar los datos","campo 'C$$HEX1$$f300$$ENDHEX$$digo Postal' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
	end if
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "complemento")) then
		messageBox ("Error al grabar los datos","campo 'Complemento' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
	end if				
	if isnull(dw_maestro.getitemstring(ll_row_maestro, "codubi")) then
		messageBox ("Error al grabar los datos","campo 'Ubicaci$$HEX1$$f300$$ENDHEX$$n' vac$$HEX1$$ed00$$ENDHEX$$o")
		return false
   end if
end if
return true
