HA$PBExportHeader$w_mnt_factibilidad_gis_wimax.srw
forward
...
if ii_tipo = 5 then  // Aprobar Pricing
   lst_par.updwprop = true
	...
	lst_par.titulo   = "Aprobaci$$HEX1$$f300$$ENDHEX$$n de Solicitud por Pricing"	
...
string text = "Validar Informaci$$HEX1$$f300$$ENDHEX$$n"
end type
