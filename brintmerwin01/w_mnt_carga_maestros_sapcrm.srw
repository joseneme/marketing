HA$PBExportHeader$w_mnt_carga_maestros_sapcrm.srw
forward
...
//					f_msg('Cliente Corporativo, debe gestionarse a trav$$HEX1$$e900$$ENDHEX$$s de SAPCRM')
//					return 0
//				end if;
				//fin sapcrm
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_cli)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_cnt)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_ubi)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_emp)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_rel)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_tel)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_telmov)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_fax)
//	else
...
//		messagebox('Aviso','El archivo se grab$$HEX2$$f3002000$$ENDHEX$$con el nombre ' + ls_archivo_email)
//	else
