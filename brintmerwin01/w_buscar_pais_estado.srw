HA$PBExportHeader$w_buscar_pais_estado.srw
...
string title = "B$$HEX1$$fa00$$ENDHEX$$squeda de Cargos "
...
if len(trim(sle_1.text))<1 and len(trim(sle_2.text))<1 then
	integer li_resp
	li_resp = MessageBox ( "B$$HEX1$$fa00$$ENDHEX$$squeda de Paises y Estados", "Desea mostrar todos los registros?" , question! , yesnocancel!, 1)
