HA$PBExportHeader$w_saveas_xls_50000.srw
forward
...
long backcolor = 67108864
string text = "x No coloque la extensi$$HEX1$$f300$$ENDHEX$$n del archivo."
...
if trim(sle_1.text)<>'' then
	...
	messagebox('Error','Ingrese un nombre de archivo v$$HEX1$$e100$$ENDHEX$$lido.')
	return
end if 
end event
