$PBExportHeader$w_filtrar_edificio.srw
...
long textcolor = 16711680
long backcolor = 67108864
string text = "Código del Edificio"
end type
...
if messagebox( "Búsqueda de Edificio", "Desea mostrar todos los registros?",question!,yesno!,2)=2 then
...
if len(trim(sle_codigo.text))<1 and len(trim(sle_edificio_nombre.text))<1 and &
	...
	integer li_resp
	li_resp = MessageBox ( "Búsqueda de Edificio", "Desea mostrar todos los registros?" , question! , yesnocancel!, 1)
