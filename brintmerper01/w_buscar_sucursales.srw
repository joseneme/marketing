HA$PBExportHeader$w_buscar_sucursales.srw
forward
global type w_buscar_sucursales from w_lov_buscar
end type
type st_1 from statictext within w_buscar_sucursales
end type
type st_2 from statictext within w_buscar_sucursales
end type
type sle_codigo from singlelineedit within w_buscar_sucursales
end type
type cb_5 from commandbutton within w_buscar_sucursales
end type
end forward
...
global w_buscar_sucursales w_buscar_sucursales
...
CloseWithReturn(w_buscar_sucursales , ist_par)
end event

on w_buscar_sucursales.create
int iCurrent
call super::create
...
on w_buscar_sucursales.destroy
call super::destroy
destroy(this.st_1)
destroy(this.st_2)
...
event close;call super::close;CloseWithReturn(w_buscar_sucursales , ist_par)
end event

type cb_buscar from w_lov_buscar`cb_buscar within w_buscar_sucursales
integer x = 2103
integer y = 44
end type

type sle_buscar from w_lov_buscar`sle_buscar within w_buscar_sucursales
integer x = 187
integer y = 164
integer width = 1797
integer taborder = 80
...
type cb_4 from w_lov_buscar`cb_4 within w_buscar_sucursales
boolean visible = false
integer taborder = 70
end type

type cb_3 from w_lov_buscar`cb_3 within w_buscar_sucursales
boolean visible = false
integer taborder = 60
end type

type cb_2 from w_lov_buscar`cb_2 within w_buscar_sucursales
boolean visible = false
integer taborder = 30
end type

type cb_1 from w_lov_buscar`cb_1 within w_buscar_sucursales
boolean visible = false
integer taborder = 20
end type

type dw_maestro from w_lov_buscar`dw_maestro within w_buscar_sucursales
integer x = 27
integer y = 260
integer width = 2551
integer height = 1436
integer taborder = 40
string dataobject = "d_buscar_sucursales"
