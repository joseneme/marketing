HA$PBExportHeader$w_lov_gastotelco.srw
forward
global type w_lov_gastotelco from w_lov_cliente
end type
type st_2 from statictext within w_lov_gastotelco
end type
type sle_codcliente from singlelineedit within w_lov_gastotelco
end type
end forward
...
global w_lov_gastotelco w_lov_gastotelco
...
//
//IF NOT ISNULL(li_idsol) THEN
//	messagebox("Aviso","Usuario ya tiene solicitud ~n Nro de Solicitud :" + string(li_idsol))
//	lst_par.parstring1 = ""
//	lst_par.parstring2 = ""
//	lst_par.parstring3 = ""
//	return	
...
type cb_buscar from w_lov_cliente`cb_buscar within w_lov_gastotelco
integer taborder = 30
end type
...
type sle_buscar from w_lov_cliente`sle_buscar within w_lov_gastotelco
integer taborder = 20
end type

type cb_4 from w_lov_cliente`cb_4 within w_lov_gastotelco
integer x = 2130
integer y = 8
integer taborder = 0
end type

type cb_3 from w_lov_cliente`cb_3 within w_lov_gastotelco
integer x = 1902
integer y = 8
integer taborder = 0
end type

type cb_2 from w_lov_cliente`cb_2 within w_lov_gastotelco
...
type cb_1 from w_lov_cliente`cb_1 within w_lov_gastotelco
boolean visible = false
integer x = 1746
integer y = 0
integer taborder = 0
...
type dw_maestro from w_lov_cliente`dw_maestro within w_lov_gastotelco
integer x = 18
integer y = 272
integer width = 3319
integer taborder = 50
...
type cb_5 from w_lov_cliente`cb_5 within w_lov_gastotelco
boolean visible = false
integer x = 1618
integer y = 28
integer taborder = 0
...
type dw_int from w_lov_cliente`dw_int within w_lov_gastotelco
integer x = 14
integer y = 272
integer taborder = 40
string dataobject = ""
...
type st_1 from w_lov_cliente`st_1 within w_lov_gastotelco
end type
