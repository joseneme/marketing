HA$PBExportHeader$w_bus_proveedor_servicio_ldn.srw
forward
global type w_bus_proveedor_servicio_ldn from w_lov_buscar
end type
type st_1 from statictext within w_bus_proveedor_servicio_ldn
end type
type cb_5 from commandbutton within w_bus_proveedor_servicio_ldn
end type
end forward
...
global w_bus_proveedor_servicio_ldn w_bus_proveedor_servicio_ldn

type variables

end variables

on w_bus_proveedor_servicio_ldn.create
int iCurrent
call super::create
...
on w_bus_proveedor_servicio_ldn.destroy
call super::destroy
destroy(this.st_1)
destroy(this.cb_5)
end on
...
dw_maestro.retrieve(ist_par.parstring1,3)
...
if dw_maestro.getrow() > 0 then
	...
	next
	ist_par.valido = true
	CloseWithReturn(w_bus_proveedor_servicio_ldn, ist_par)
end if
end event
...
type cb_buscar from w_lov_buscar`cb_buscar within w_bus_proveedor_servicio_ldn
...
type sle_buscar from w_lov_buscar`sle_buscar within w_bus_proveedor_servicio_ldn
boolean visible = false
integer x = 105
integer y = 36
boolean enabled = false
...
type cb_4 from w_lov_buscar`cb_4 within w_bus_proveedor_servicio_ldn
boolean visible = false
integer x = 1106
end type

type cb_3 from w_lov_buscar`cb_3 within w_bus_proveedor_servicio_ldn
boolean visible = false
integer x = 782
end type

type cb_2 from w_lov_buscar`cb_2 within w_bus_proveedor_servicio_ldn
boolean visible = false
integer x = 457
end type

type cb_1 from w_lov_buscar`cb_1 within w_bus_proveedor_servicio_ldn
boolean visible = false
integer x = 133
end type

type dw_maestro from w_lov_buscar`dw_maestro within w_bus_proveedor_servicio_ldn
integer x = 23
integer y = 144
integer width = 2949
integer height = 684
string dataobject = "d_lis_proveedor_servicio_ldn"
...
event dw_maestro::ue_retrieve;return dw_maestro.retrieve(ist_par.parstring1,3)
