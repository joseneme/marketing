HA$PBExportHeader$w_mnt_caja_terminal.srw
...
integer height = 1756
long backcolor = 79741120
string text = "B$$HEX1$$fa00$$ENDHEX$$squeda Clientes"
...
fontfamily fontfamily = swiss!
string facename = "Arial"
string text = "Unificaci$$HEX1$$f300$$ENDHEX$$n"
end type
...
If dw_16.retrieve()=0 then
	messagebox('Aviso','No existen clientes asociados a los par$$HEX1$$e100$$ENDHEX$$metros de busqueda')
	return;
End If
