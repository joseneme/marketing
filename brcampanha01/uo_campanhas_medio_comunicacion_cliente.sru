HA$PBExportHeader$uo_campanhas_medio_comunicacion_cliente.sru
forward
...
//Medios de Comunicaci$$HEX1$$f300$$ENDHEX$$n del Cliente en base
...
if row > 0  then
	...
	if li_total > 0 then
		...
		//Selecciona el MedCom que est$$HEX2$$e1002000$$ENDHEX$$en base
