HA$PBExportHeader$modintmer.sra
...
string gsNomSis		//C$$HEX1$$f300$$ENDHEX$$digo del M$$HEX1$$f300$$ENDHEX$$dulo $$HEX2$$26202000$$ENDHEX$$MODVTA, MODPIN
string gsNomApl		//Nombre Largo del M$$HEX1$$f300$$ENDHEX$$dulo $$HEX1$$2620$$ENDHEX$$. M$$HEX1$$f300$$ENDHEX$$dulo de Ventas
string gsNomIni		//Calculado en w_segur, Nombre del ini con ruta completa (Ruta + gsNomSis + $$HEX1$$1820$$ENDHEX$$.Ini$$HEX1$$1920$$ENDHEX$$)
string gsrutabmp

string gsDw		//Para el mantenimiento, Nombre del Datawindow
string gsTMnt		//T$$HEX1$$ed00$$ENDHEX$$tulo del mantenimiento
string gsDw1		//Para el mantenimiento Cabecera-Detalle, Nombre del Datawindow Detalle
string gsDwPrint		//Para el mantenimiento, Nombre del Datawindow de Impresi$$HEX1$$f300$$ENDHEX$$n
...
gsNomApl = "M$$HEX1$$f300$$ENDHEX$$dulo Inteligencia de Mercado"
window w_ventana
...
if liArgs = -1 then
   messagebox(gsNomApl,'Modo de acceso inv$$HEX1$$e100$$ENDHEX$$lido')
   return
end if
